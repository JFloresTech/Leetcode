...
SELECT Visits.customer_id AS customer_id, COUNT(Visits.visit_id) AS count_no_trans
...
/* REMOVE 
 USE master
 GO
 ALTER DATABASE [Leetcode_1581] 
 SET SINGLE_USER 
 WITH ROLLBACK IMMEDIATE
 DROP DATABASE [Leetcode_1581]
*/